(** * NormalForm.v
    ...
    Lemma 4.2 ([toTerm_inj]), which is established in [Model.v] (via the total
    interpretation [interp]) and re-exported by [Decidable.v]; it is NOT proved
    in this file. Every smart constructor below provably preserves the
